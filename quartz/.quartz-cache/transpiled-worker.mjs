...
function slugifyFilePath(fp, excludeExt) {
  ...
  let slug2 = withoutFileExt.split("/").map((segment) => segment.replace(/\s/g, "-")).join("/").replace(/\/$/, "");
      ...
      return [
        ...
        () => {
          return (_, file) => {
            ...
            data.tags = data.tags?.map((tag) => slugTag(tag)) ?? [];
            ...
            visit(tree, "element", (node, _index, _parent) => {
              if (node.tagName === "a" && node.properties && typeof node.properties.href === "string") {
                ...
                if (isInternal) {
                  ...
                  const simple = decodeURI(simplifySlug(destCanonical));
                  outgoing.add(simple);
...
import { slug as slugAnchor3 } from "github-slugger";
var defaultOptions7 = {
  maxDepth: 3,
  minEntries: 1,
  showByDefault: true
...
function ArticleTitle({ fileData }) {
  ...
  if (title) {
    return /* @__PURE__ */ jsx14("h1", { class: "article-title", children: title });
  } else {
    return null;
  }
}
...
function Darkmode() {
  return /* @__PURE__ */ jsxs9("div", { class: "darkmode", children: [
...
var Head_default = /* @__PURE__ */ __name(() => {
  function Head({ cfg, fileData, externalResources }) {
    ...
    return /* @__PURE__ */ jsxs10("head", { children: [
      ...
      /* @__PURE__ */ jsx16("meta", { name: "generator", content: "Zane's Notes" }),
      /* @__PURE__ */ jsx16("script", { defer: true, "data-domain": "zanefitzgerald.me", src: "https://plausible.io/js/script.js" }),
      ...
      /* @__PURE__ */ jsx16("script", { defer: true, src: "https://static.cloudflareinsights.com/beacon.min.js", "data-cf-beacon": '{"token": "e892211d78ce48ebae0b70efdcd502cf"}' }),
...
function PageTitle({ fileData, cfg }) {
  ...
  return /* @__PURE__ */ jsx17("h1", { class: "page-title", children: /* @__PURE__ */ jsx17("a", { href: baseDir, children: title }) });
}
...
function Spacer({ displayClass }) {
  ...
  return /* @__PURE__ */ jsx19("div", { class: className });
}
...
function ExplorerNode({ node, opts, fullPath, fileData }) {
  ...
  return /* @__PURE__ */ jsx21("div", { children: node.file ? (
    // Single file node
    /* @__PURE__ */ jsx21("li", { children: /* @__PURE__ */ jsx21("a", { href: resolveRelative(fileData.slug, node.file.slug), "data-for": node.file.slug, children: node.file.frontmatter?.title }) }, node.file.slug)
    ...
    /* @__PURE__ */ jsxs12("div", { class: "folder-container", children: [
      ...
      /* @__PURE__ */ jsx21("li", { "data-folderpath": folderPath, children: folderBehavior === "link" ? /* @__PURE__ */ jsx21("a", { href: `${folderPath}`, "data-for": node.name, class: "folder-title", children: node.name }) : /* @__PURE__ */ jsx21("button", { class: "folder-button", children: /* @__PURE__ */ jsx21("h3", { class: "folder-title", children: node.name }) }) }, node.name)
    ] }),
...
var defaultOptions9 = /* @__PURE__ */ __name(() => ({
  title: "Explorer",
    ...
    return /* @__PURE__ */ jsxs13("div", { class: `explorer ${displayClass}`, children: [
      /* @__PURE__ */ jsxs13(
        "button",
        {
          ...
          "data-tree": jsonTree,
          children: [
            /* @__PURE__ */ jsx22("h3", { children: opts.title }),
            /* @__PURE__ */ jsx22(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      /* @__PURE__ */ jsx22("div", { id: "explorer-content", children: /* @__PURE__ */ jsx22("ul", { class: "overflow", children: /* @__PURE__ */ jsx22(ExplorerNode, { node: fileTree, opts, fileData }) }) })
    ] });
  }
...
function TagList({ fileData }) {
  ...
  if (tags && tags.length > 0) {
    return /* @__PURE__ */ jsx23("ul", { class: "tags", children: tags.map((tag) => {
      const display = `#${tag}`;
...
var Graph_default = /* @__PURE__ */ __name((opts) => {
  function Graph() {
    ...
    return /* @__PURE__ */ jsxs14("div", { class: "graph", children: [
...
function Backlinks({ fileData, allFiles }) {
  ...
  return /* @__PURE__ */ jsxs15("div", { class: "backlinks", children: [
...
var Search_default = /* @__PURE__ */ __name(() => {
  function Search() {
    return /* @__PURE__ */ jsxs16("div", { class: "search", children: [
...
var Footer_default = /* @__PURE__ */ __name((opts) => {
  function Footer() {
    ...
    return /* @__PURE__ */ jsxs17("footer", { children: [
      /* @__PURE__ */ jsx27("hr", {}),
      /* @__PURE__ */ jsxs17("p", { children: [
        "Sourced from my ",
        /* @__PURE__ */ jsx27("a", { href: "https://obsidian.md/", children: "Obsidian" }),
        " notes."
      ] }),
      /* @__PURE__ */ jsx27("br", {}),
      /* @__PURE__ */ jsx27("ul", { children: Object.entries(links).map(([text, link]) => /* @__PURE__ */ jsx27("li", { children: /* @__PURE__ */ jsx27("a", { style: "opacity: 0.8", href: link, children: text }) })) })
    ] });
  }
...
// quartz/components/styles/avatar.scss
var avatar_default = "";

// quartz/components/Avatar.tsx
import { jsx as jsx31 } from "preact/jsx-runtime";
function Avatar({ fileData }) {
  const author = fileData.frontmatter?.author;
  ...
  return /* @__PURE__ */ jsx31("div", { class: "avatar-div", children: /* @__PURE__ */ jsx31("img", { class: "avatar-image avatar-a1", draggable: false, src: avatarimageurl }) });
}
__name(Avatar, "Avatar");
Avatar.css = avatar_default;
var Avatar_default = /* @__PURE__ */ __name(() => Avatar, "default");

// quartz/components/FlipDownTimer.tsx
import { jsx as jsx32 } from "preact/jsx-runtime";
function FlipdownTimer() {
  return /* @__PURE__ */ jsx32("div", { children: /* @__PURE__ */ jsx32("div", { id: "flipdown", class: "flipdown" }) });
}
__name(FlipdownTimer, "FlipdownTimer");
FlipdownTimer.css = avatar_default;

// quartz/components/scripts/GoldStraw.inline.ts
var GoldStraw_inline_default = "";

// quartz/components/GoldStraw.tsx
import { jsx as jsx33 } from "preact/jsx-runtime";
function GoldStraw({ fileData }) {
  const goldstraw = fileData.frontmatter?.goldstraw;
  const data = fileData.text;
  return /* @__PURE__ */ jsx33("div", { class: "goldstraw-div", children: /* @__PURE__ */ jsx33("button", { class: "goldstraw-main", id: "goldstraw-docx" }) });
  if (true) {
    return /* @__PURE__ */ jsx33("div", { class: "goldstraw-div", children: /* @__PURE__ */ jsx33("button", { class: "goldstraw-main", id: "goldstraw-docx" }) });
  } else
    return null;
}
__name(GoldStraw, "GoldStraw");
GoldStraw.afterDOMLoaded = GoldStraw_inline_default;
...
var defaultContentPageLayout = {
  beforeBody: [Avatar_default(), ArticleTitle_default(), ContentMeta_default(), TagList_default()],
  left: [
    PageTitle_default(),
