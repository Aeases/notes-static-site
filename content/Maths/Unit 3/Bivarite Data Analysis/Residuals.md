...
![[Untitled 2.png]]
>(In this examle the linear model is not appropriate as a pattern is evident on the Regression Plot)

>[!example]- Plotting Residual Plot w/ classpad
>

#### Determining If Linear Model is appropriate
A Pattern that is easily visible means that the linear model is not appropriate. ![[mathregressionplots.png]]
